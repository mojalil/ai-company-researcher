...
from models import FundingInfoList, PositionInfo, PositionInfoList
    ...
    def extract_funding_details(self, agent: Agent, companies: list[str]):
        return Task(
            ...
            expected_output=dedent("""A list of JSON objects, each representing a funding round with 
                                      ...
                                      details."""),
            callback=self.append_event_callback,
            output_json=FundingInfoList,  # Assuming your framework supports this to specify output should be in JSON format
